...
card1 = CreditCard.create(name: "Visa", user_id: 1, debt: 30000.00, interest_rate: 25.00, min_payment: 50.00)
card2 = CreditCard.create(name: "American Express", user_id: 1, debt: 10000.00, interest_rate: 20.00, min_payment: 2.00)

period1 = Period.create(credit_card_id: 1, start_month: "July", start_year: 2016, end_month: "July", end_year: 2016, expenditure: 2500, payment: 7000, name: Faker::Space.nasa_space_craft)
period2 = Period.create(credit_card_id: 1, start_month: "August", start_year: 2016, end_month: "October", end_year: 2016, expenditure: 3000, payment: 7500, name: Faker::Space.planet)
