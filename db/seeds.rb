...
card1 = CreditCard.create(name: "Visa", user_id: 1, debt: 70000.00, interest_rate: 25.00, min_payment: 2.00)
...
period2 = Period.create(credit_card_id: 1, start_month: "August", start_year: 2016, end_month: "October", end_year: 2016, expenditure: 5000, payment: 7500, name: Faker::Space.planet)
