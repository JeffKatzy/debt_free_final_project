...
card1 = CreditCard.create(name: "Visa", user_id: 1, debt: 500.00, interest_rate: 5.00, min_payment: 5.00)
card2 = CreditCard.create(name: "Visa", user_id: 2, debt: 500.00, interest_rate: 5.00, min_payment: 5.00)
